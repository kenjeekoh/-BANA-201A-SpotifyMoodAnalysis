...
client_id = '4ba534264eaa42a3bf4625d3804dd7d1'
client_secret = 'ffe8c2f8e17a4d0a9f449e957dee1786'
...
def get_top_tracks(sp, num_tracks=100):
    # Get the top tracks playlist for 2023
    playlist_uri = 'spotify:playlist:3sPldcFm8nyI7yFs6rMO0l' # INPUT SPOTIFY PLAYLIST URI HERE
...
# Example usage
tracks, track_ids = get_top_tracks(sp)
top_tracks_audio_features = get_audio_features(sp, track_ids)

# Combine track data and audio features into a DataFrame
top_tracks_w_audio_features = combine_track_data_and_features(tracks, top_tracks_audio_features)

# Export top_tracks_2023_w_audio_features dataframe into a .csv file
top_tracks_w_audio_features.to_csv('top_tracks_2023_w_audio_features.csv') # Don't forget to label the year